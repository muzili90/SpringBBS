...
<script src="${ctx}/js/mypace/nodeIndex.js"></script>
...
<body>
	...
	<div class="col-md-6 border-md6">
			...
			<label class="label-label" data-toggle="dropdown">
     		<a class="alabel" href="#">标签</a><span class="caret"></span>
   				...
   				<ul class="dropdown-menu" role="menu">
      				...
      				<input name="hiddenNodeIndexValue" type="hidden" value='<s:property value="#node.id"/>'>
      				</s:iterator>
   				</ul>
			</div>
		...
		<div class="row bbs-center-border">
			...
			<button class="btn btn-info btn-sm"><s:property value="#topic.node.name"/></button>
